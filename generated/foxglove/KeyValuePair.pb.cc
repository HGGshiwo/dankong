...
const ::google::protobuf::uint32
    TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::KeyValuePair,
                                                       _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
static ::google::protobuf::Message const* const file_default_instances[] = {
    reinterpret_cast<const ::google::protobuf::Message*>(
        &::foxglove::_KeyValuePair_default_instance_),
};

void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors("foxglove/KeyValuePair.proto", schemas,
...
const ::google::protobuf::Descriptor* KeyValuePair::descriptor() {
    ::protobuf_foxglove_2fKeyValuePair_2eproto::
        protobuf_AssignDescriptorsOnce();
    return ::protobuf_foxglove_2fKeyValuePair_2eproto::file_level_metadata
...
KeyValuePair::InternalSerializeWithCachedSizesToArray(
...
namespace protobuf {
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::foxglove::KeyValuePair*
