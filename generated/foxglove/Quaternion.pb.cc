...
static void InitDefaultsQuaternion() {
    ...
    {
        void* ptr = &::foxglove::_Quaternion_default_instance_;
        new (ptr)::foxglove::Quaternion();
        ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
    }
    ::foxglove::Quaternion::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32
    TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::Quaternion,
                                                       _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
static const ::google::protobuf::internal::MigrationSchema
    schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, sizeof(::foxglove::Quaternion)},
};
...
void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors("foxglove/Quaternion.proto", schemas,
...
void AddDescriptorsImpl() {
    ...
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
        "foxglove/Quaternion.proto", &protobuf_RegisterTypes);
}
...
Quaternion::Quaternion()
    ...
    SharedCtor();
    // @@protoc_insertion_point(constructor:foxglove.Quaternion)
}
...
const ::google::protobuf::Descriptor* Quaternion::descriptor() {
    ::protobuf_foxglove_2fQuaternion_2eproto::protobuf_AssignDescriptorsOnce();
    return ::protobuf_foxglove_2fQuaternion_2eproto::file_level_metadata
...
#define DO_(EXPRESSION) \
    ...
    // @@protoc_insertion_point(parse_start:foxglove.Quaternion)
    for (;;) {
...
success:
    // @@protoc_insertion_point(parse_success:foxglove.Quaternion)
    return true;
failure:
    // @@protoc_insertion_point(parse_failure:foxglove.Quaternion)
    return false;
#undef DO_
}
...
void Quaternion::SerializeWithCachedSizes(
    ...
    // @@protoc_insertion_point(serialize_start:foxglove.Quaternion)
    ::google::protobuf::uint32 cached_has_bits = 0;
    (void)cached_has_bits;
    ...
    // double w = 4;
    if (this->w() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(4, this->w(),
                                                                  output);
    }
    ...
    // @@protoc_insertion_point(serialize_end:foxglove.Quaternion)
}
...
void Quaternion::MergeFrom(const ::google::protobuf::Message& from) {
    // @@protoc_insertion_point(generalized_merge_from_start:foxglove.Quaternion)
    GOOGLE_DCHECK_NE(&from, this);
    const Quaternion* source =
        ::google::protobuf::internal::DynamicCastToGenerated<const Quaternion>(
            &from);
    if (source == NULL) {
        // @@protoc_insertion_point(generalized_merge_from_cast_fail:foxglove.Quaternion)
        ::google::protobuf::internal::ReflectionOps::Merge(from, this);
    } else {
        // @@protoc_insertion_point(generalized_merge_from_cast_success:foxglove.Quaternion)
        MergeFrom(*source);
    }
}
...
void Quaternion::CopyFrom(const ::google::protobuf::Message& from) {
    // @@protoc_insertion_point(generalized_copy_from_start:foxglove.Quaternion)
    if (&from == this) return;
    Clear();
    MergeFrom(from);
}
...
namespace protobuf {
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::foxglove::Quaternion*
Arena::CreateMaybeMessage<::foxglove::Quaternion>(Arena* arena) {
    return Arena::CreateInternal<::foxglove::Quaternion>(arena);
}
}  // namespace protobuf
}  // namespace google
