...
class Vector2DefaultTypeInternal {
   public:
    ::google::protobuf::internal::ExplicitlyConstructed<Vector2> _instance;
...
const ::google::protobuf::uint32
    TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::Vector2,
                                                       _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors("foxglove/Vector2.proto", schemas, file_default_instances,
...
Vector2::Vector2() : ::google::protobuf::Message(), _internal_metadata_(NULL) {
...
const ::google::protobuf::Descriptor* Vector2::descriptor() {
    ...
    return ::protobuf_foxglove_2fVector2_2eproto::file_level_metadata
...
namespace protobuf {
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::foxglove::Vector2*
