...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_foxglove_2fColor_2eproto ::google::
    protobuf::internal::SCCInfo<0>
        scc_info_Color;
}  // namespace protobuf_foxglove_2fColor_2eproto
namespace protobuf_foxglove_2fKeyValuePair_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_foxglove_2fKeyValuePair_2eproto ::
    google::protobuf::internal::SCCInfo<0>
        scc_info_KeyValuePair;
}  // namespace protobuf_foxglove_2fKeyValuePair_2eproto
namespace protobuf_foxglove_2fVector3_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_foxglove_2fVector3_2eproto ::google::
    protobuf::internal::SCCInfo<0>
        scc_info_Vector3;
}  // namespace protobuf_foxglove_2fVector3_2eproto
namespace protobuf_google_2fprotobuf_2ftimestamp_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fprotobuf_2ftimestamp_2eproto ::
    google::protobuf::internal::SCCInfo<0>
        scc_info_Timestamp;
}  // namespace protobuf_google_2fprotobuf_2ftimestamp_2eproto
namespace foxglove {
class LocationFixDefaultTypeInternal {
   public:
    ::google::protobuf::internal::ExplicitlyConstructed<LocationFix> _instance;
...
::google::protobuf::internal::SCCInfo<4> scc_info_LocationFix = {
    {ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized),
     4, InitDefaultsLocationFix},
    {
        &protobuf_google_2fprotobuf_2ftimestamp_2eproto::scc_info_Timestamp
             .base,
...
const ::google::protobuf::uint32
    TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::LocationFix,
                                                       _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(
            ::foxglove::LocationFix, position_covariance_type_),
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::LocationFix,
                                                       heading_),
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::LocationFix,
                                                       velocity_),
...
static ::google::protobuf::Message const* const file_default_instances[] = {
    reinterpret_cast<const ::google::protobuf::Message*>(
        &::foxglove::_LocationFix_default_instance_),
};

void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors("foxglove/LocationFix.proto", schemas,
...
void AddDescriptorsImpl() {
    ...
    static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        "\n\032foxglove/LocationFix.proto\022\010foxglove\032\024"
        "foxglove/Color.proto\032\033foxglove/KeyValueP"
        "air.proto\032\026foxglove/Vector3.proto\032\037googl"
        "e/protobuf/timestamp.proto\"\312\003\n\013LocationF"
        "ix\022-\n\ttimestamp\030\006 \001(\0132\032.google.protobuf."
        "Timestamp\022\020\n\010frame_id\030\007 "
        "\001(\t\022\020\n\010latitude\030"
        "\001 \001(\001\022\021\n\tlongitude\030\002 "
        "\001(\001\022\020\n\010altitude\030\003 \001"
        "(\001\022\033\n\023position_covariance\030\004 "
        "\003(\001\022N\n\030posit"
        "ion_covariance_type\030\005 \001(\0162,.foxglove.Loc"
        "ationFix.PositionCovarianceType\022\017\n\007headi"
        "ng\030\n \001(\001\022#\n\010velocity\030\013 "
        "\001(\0132\021.foxglove.Ve"
        "ctor3\022\036\n\005color\030\010 \001(\0132\017.foxglove.Color\022(\n"
        "\010metadata\030\t \003(\0132\026.foxglove.KeyValuePair\""
        "V\n\026PositionCovarianceType\022\013\n\007UNKNOWN\020\000\022\020"
        "\n\014APPROXIMATED\020\001\022\022\n\016DIAGONAL_"
        "KNOWN\020\002\022\t\n\005"
        "KNOWN\020\003b\006proto3"};
...
LocationFix_PositionCovarianceType_descriptor() {
    ...
    return protobuf_foxglove_2fLocationFix_2eproto::file_level_enum_descriptors
        [0];
}
...
const LocationFix_PositionCovarianceType
    LocationFix::PositionCovarianceType_MIN;
const LocationFix_PositionCovarianceType
    LocationFix::PositionCovarianceType_MAX;
...
void LocationFix::InitAsDefaultInstance() {
    ::foxglove::_LocationFix_default_instance_._instance.get_mutable()
        ->timestamp_ = const_cast<::google::protobuf::Timestamp*>(
        ::google::protobuf::Timestamp::internal_default_instance());
    ::foxglove::_LocationFix_default_instance_._instance.get_mutable()
        ->velocity_ = const_cast<::foxglove::Vector3*>(
        ::foxglove::Vector3::internal_default_instance());
    ::foxglove::_LocationFix_default_instance_._instance.get_mutable()->color_ =
        const_cast<::foxglove::Color*>(
...
const int LocationFix::kHeadingFieldNumber;
const int LocationFix::kVelocityFieldNumber;
const int LocationFix::kColorFieldNumber;
const int LocationFix::kMetadataFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
LocationFix::LocationFix(const LocationFix& from)
    ...
    frame_id_.UnsafeSetDefault(
        &::google::protobuf::internal::GetEmptyStringAlreadyInited());
    if (from.frame_id().size() > 0) {
        frame_id_.AssignWithDefault(
            &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
            from.frame_id_);
    }
    ...
    if (from.has_velocity()) {
        velocity_ = new ::foxglove::Vector3(*from.velocity_);
    } else {
        velocity_ = NULL;
    }
    ::memcpy(&latitude_, &from.latitude_,
             static_cast<size_t>(
                 ...
                 sizeof(position_covariance_type_));
...
const ::google::protobuf::Descriptor* LocationFix::descriptor() {
    ::protobuf_foxglove_2fLocationFix_2eproto::protobuf_AssignDescriptorsOnce();
    return ::protobuf_foxglove_2fLocationFix_2eproto::file_level_metadata
        ...
        switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(
            ...
            case 4: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    ...
                    DO_((::google::protobuf::internal::WireFormatLite::
                             ReadPackedPrimitive<
                                 double, ::google::protobuf::internal::
                                             WireFormatLite::TYPE_DOUBLE>(
                    ...
                    DO_((::google::protobuf::internal::WireFormatLite::
                             ReadRepeatedPrimitiveNoInline<
                                 double, ::google::protobuf::internal::
                                             WireFormatLite::TYPE_DOUBLE>(
                                 1, 34u, input,
                                 this->mutable_position_covariance())));
                } else {
                    goto handle_unusual;
                }
                break;
            ...
            case 5: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    ...
                    int value;
                    DO_((::google::protobuf::internal::WireFormatLite::
                             ReadPrimitive<int, ::google::protobuf::internal::
                                                    WireFormatLite::TYPE_ENUM>(
                                 input, &value)));
                    set_position_covariance_type(
                        static_cast<
                            ::foxglove::LocationFix_PositionCovarianceType>(
                            value));
                } else {
                    goto handle_unusual;
                }
            ...
            case 6: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    static_cast<::google::protobuf::uint8>(
                        50u /* 50 & 0xFF */)) {
                    DO_(::google::protobuf::internal::WireFormatLite::
                            ReadMessage(input, mutable_timestamp()));
                } else {
                    goto handle_unusual;
                }
                break;
            ...
            case 7: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    static_cast<::google::protobuf::uint8>(
                        58u /* 58 & 0xFF */)) {
                    DO_(::google::protobuf::internal::WireFormatLite::
                            ReadString(input, this->mutable_frame_id()));
                    DO_(::google::protobuf::internal::WireFormatLite::
                            VerifyUtf8String(
                                this->frame_id().data(),
                                static_cast<int>(this->frame_id().length()),
            ...
            case 8: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    static_cast<::google::protobuf::uint8>(
                        66u /* 66 & 0xFF */)) {
                    DO_(::google::protobuf::internal::WireFormatLite::
                            ReadMessage(input, mutable_color()));
                } else {
                    goto handle_unusual;
                }
                break;
            ...
            case 9: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    static_cast<::google::protobuf::uint8>(
                        74u /* 74 & 0xFF */)) {
                    DO_(::google::protobuf::internal::WireFormatLite::
                            ReadMessage(input, add_metadata()));
                } else {
                    goto handle_unusual;
                }
                break;
            ...
            case 11: {
                if (static_cast<::google::protobuf::uint8>(tag) ==
                    static_cast<::google::protobuf::uint8>(
                        90u /* 90 & 0xFF */)) {
                    DO_(::google::protobuf::internal::WireFormatLite::
                            ReadMessage(input, mutable_velocity()));
                } else {
                    goto handle_unusual;
                }
                break;
...
void LocationFix::SerializeWithCachedSizes(
    ...
    if (this->position_covariance_size() > 0) {
        ...
        ::google::protobuf::internal::WireFormatLite::WriteDoubleArray(
            this->position_covariance().data(),
            this->position_covariance_size(), output);
    }
    ...
    if (this->has_color()) {
        ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
            8, this->_internal_color(), output);
    }

    // repeated .foxglove.KeyValuePair metadata = 9;
    for (unsigned int i = 0,
                      n = static_cast<unsigned int>(this->metadata_size());
         i < n; i++) {
        ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
            9, this->metadata(static_cast<int>(i)), output);
    }

    // double heading = 10;
    if (this->heading() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(
            10, this->heading(), output);
    }
...
::google::protobuf::uint8* LocationFix::InternalSerializeWithCachedSizesToArray(
    ...
    if (this->has_timestamp()) {
        target = ::google::protobuf::internal::WireFormatLite::
            InternalWriteMessageToArray(6, this->_internal_timestamp(),
    ...
    if (this->has_color()) {
        target = ::google::protobuf::internal::WireFormatLite::
            InternalWriteMessageToArray(8, this->_internal_color(),
                                        deterministic, target);
    }
    ...
    for (unsigned int i = 0,
         ...
         i < n; i++) {
        target = ::google::protobuf::internal::WireFormatLite::
            InternalWriteMessageToArray(9, this->metadata(static_cast<int>(i)),
                                        deterministic, target);
    }
    ...
    if (this->heading() != 0) {
        target =
            ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(
                10, this->heading(), target);
    }

    // .foxglove.Vector3 velocity = 11;
    if (this->has_velocity()) {
        target = ::google::protobuf::internal::WireFormatLite::
            InternalWriteMessageToArray(11, this->_internal_velocity(),
                                        deterministic, target);
    }
...
size_t LocationFix::ByteSizeLong() const {
    ...
    {
        unsigned int count =
            static_cast<unsigned int>(this->position_covariance_size());
    ...
    if (this->has_color()) {
        total_size +=
            1 +
            ::google::protobuf::internal::WireFormatLite::MessageSize(*color_);
    }
...
void LocationFix::MergeFrom(const LocationFix& from) {
    ...
    if (from.has_timestamp()) {
        mutable_timestamp()->::google::protobuf::Timestamp::MergeFrom(
            from.timestamp());
    }
    if (from.has_color()) {
    ...
    if (from.has_velocity()) {
        mutable_velocity()->::foxglove::Vector3::MergeFrom(from.velocity());
    }
    if (from.latitude() != 0) {
...
namespace protobuf {
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::foxglove::LocationFix*
