...
namespace protobuf {
template <>
::foxglove::Pose* Arena::CreateMaybeMessage<::foxglove::Pose>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
class Pose
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.Pose)
                   */
{
   public:
    Pose();
...
inline const ::foxglove::Quaternion& Pose::orientation() const {
    ...
    return p != NULL ? *p
                     : *reinterpret_cast<const ::foxglove::Quaternion*>(
...
inline ::foxglove::Quaternion* Pose::mutable_orientation() {
    if (orientation_ == NULL) {
        auto* p =
            CreateMaybeMessage<::foxglove::Quaternion>(GetArenaNoVirtual());
        orientation_ = p;
    }
    // @@protoc_insertion_point(field_mutable:foxglove.Pose.orientation)
    return orientation_;
}
inline void Pose::set_allocated_orientation(
