...
const ::google::protobuf::uint32
    TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::foxglove::Color,
                                                       _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
...
void protobuf_AssignDescriptors() {
    AddDescriptors();
    AssignDescriptors("foxglove/Color.proto", schemas, file_default_instances,
...
Color::Color() : ::google::protobuf::Message(), _internal_metadata_(NULL) {
...
const ::google::protobuf::Descriptor* Color::descriptor() {
    ...
    return ::protobuf_foxglove_2fColor_2eproto::file_level_metadata
...
void Color::SerializeWithCachedSizes(
    ...
    // double r = 1;
    if (this->r() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(1, this->r(),
                                                                  output);
    }

    // double g = 2;
    if (this->g() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(2, this->g(),
                                                                  output);
    }

    // double b = 3;
    if (this->b() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(3, this->b(),
                                                                  output);
    }

    // double a = 4;
    if (this->a() != 0) {
        ::google::protobuf::internal::WireFormatLite::WriteDouble(4, this->a(),
                                                                  output);
    }
...
namespace protobuf {
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::foxglove::Color*
