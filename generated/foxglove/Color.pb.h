...
namespace protobuf {
template <>
::foxglove::Color* Arena::CreateMaybeMessage<::foxglove::Color>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
class Color
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.Color)
                   */
{
   public:
    Color();
...
#if LANG_CXX11
    Color(Color&& from) noexcept : Color() { *this = ::std::move(from); }
    ...
    static inline const Color* internal_default_instance() {
        return reinterpret_cast<const Color*>(&_Color_default_instance_);
    }
    ...
    inline Color* New() const final { return CreateMaybeMessage<Color>(NULL); }
