...
namespace protobuf {
template <>
::foxglove::Quaternion* Arena::CreateMaybeMessage<::foxglove::Quaternion>(
    Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
class Quaternion
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.Quaternion)
                   */
{
   public:
    Quaternion();
...
#if LANG_CXX11
    Quaternion(Quaternion&& from) noexcept : Quaternion() {
        *this = ::std::move(from);
    }
