...
namespace protobuf {
template <>
::foxglove::KeyValuePair* Arena::CreateMaybeMessage<::foxglove::KeyValuePair>(
    Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
class KeyValuePair
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.KeyValuePair)
                   */
{
   public:
    KeyValuePair();
...
#if LANG_CXX11
    KeyValuePair(KeyValuePair&& from) noexcept : KeyValuePair() {
        *this = ::std::move(from);
    }
