...
namespace protobuf {
template <>
::foxglove::Log* Arena::CreateMaybeMessage<::foxglove::Log>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
inline const ::std::string& Log_Level_Name(Log_Level value) {
    return ::google::protobuf::internal::NameOfEnum(Log_Level_descriptor(),
                                                    value);
}
inline bool Log_Level_Parse(const ::std::string& name, Log_Level* value) {
...
class Log
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.Log)
                   */
{
   public:
    Log();
...
#if LANG_CXX11
    Log(Log&& from) noexcept : Log() { *this = ::std::move(from); }
    ...
    static inline const Log* internal_default_instance() {
        return reinterpret_cast<const Log*>(&_Log_default_instance_);
    }
    ...
    inline Log* New() const final { return CreateMaybeMessage<Log>(NULL); }
   ...
   public:
    ...
    static const Level UNKNOWN = Log_Level_UNKNOWN;
    static const Level DEBUG = Log_Level_DEBUG;
    static const Level INFO = Log_Level_INFO;
    static const Level WARNING = Log_Level_WARNING;
    static const Level ERROR = Log_Level_ERROR;
    static const Level FATAL = Log_Level_FATAL;
    static inline bool Level_IsValid(int value) {
        return Log_Level_IsValid(value);
    }
    static const Level Level_MIN = Log_Level_Level_MIN;
    static const Level Level_MAX = Log_Level_Level_MAX;
    static const int Level_ARRAYSIZE = Log_Level_Level_ARRAYSIZE;
    ...
    static inline bool Level_Parse(const ::std::string& name, Level* value) {
...
inline void Log::set_allocated_timestamp(
...
inline void Log::set_allocated_message(::std::string* message) {
    ...
    message_.SetAllocatedNoArena(
        &::google::protobuf::internal::GetEmptyStringAlreadyInited(), message);
...
inline void Log::set_allocated_file(::std::string* file) {
    ...
    file_.SetAllocatedNoArena(
        &::google::protobuf::internal::GetEmptyStringAlreadyInited(), file);
...
template <>
struct is_proto_enum<::foxglove::Log_Level> : ::std::true_type {};
template <>
