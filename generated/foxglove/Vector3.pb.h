...
#ifndef PROTOBUF_INCLUDED_foxglove_2fVector3_2eproto
#define PROTOBUF_INCLUDED_foxglove_2fVector3_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_foxglove_2fVector3_2eproto
...
namespace protobuf {
template <>
::foxglove::Vector3* Arena::CreateMaybeMessage<::foxglove::Vector3>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace foxglove {
...
class Vector3
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:foxglove.Vector3)
                   */
{
   public:
    Vector3();
...
#if LANG_CXX11
    Vector3(Vector3&& from) noexcept : Vector3() { *this = ::std::move(from); }
    ...
    static inline const Vector3* internal_default_instance() {
        return reinterpret_cast<const Vector3*>(&_Vector3_default_instance_);
    }
   ...
   private:
    ...
    friend struct ::protobuf_foxglove_2fVector3_2eproto::TableStruct;
};
// ===================================================================
...
#endif  // PROTOBUF_INCLUDED_foxglove_2fVector3_2eproto
